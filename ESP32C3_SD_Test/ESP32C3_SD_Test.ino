/**
 * ============================================================
 *  SD Card Test untuk ESP32-C3
 * ============================================================
 *
 * Wiring SD Card ke ESP32-C3 (Standard SPI):
 * --------------------------------------------------
 *    SD_CS   → GPIO 7
 *    MOSI    → GPIO 6
 *    MISO    → GPIO 5
...
// ============================================================
//  Konfigurasi Pin — Standard ESP32-C3 SPI
// ============================================================
#define SD_CS_PIN   7
#define SPI_MOSI    6
#define SPI_MISO    5
...
#define TEST_CONTENT    "ESP32-C3 SD Card Test OK"
...
void setup() {
  ...
  Serial.println("========================================");
  Serial.println("  SD Card Test - ESP32-C3");
  Serial.println("========================================");

  // Inisialisasi SPI dengan pin standard ESP32-C3
...
void printTroubleshooting() {
  ...
  Serial.println("  ─────────────────────────────────────────");
  Serial.println("  1. Pastikan pin CS (SD_CS_PIN) sudah benar (GPIO 7)");
  Serial.println("  2. Cek apakah kartu SD diformat FAT32");
  Serial.println("  3. Pastikan wiring: SCK=4, MISO=5, MOSI=6, CS=7");
